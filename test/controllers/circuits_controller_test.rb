...
class CircuitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create circuit" do
    assert_difference('Circuit.count') do
      post circuits_url, params: { circuit: { description: @circuit.description, name: @circuit.name } }
    end
  ...
  test "should update circuit" do
    patch circuit_url(@circuit), params: { circuit: { description: @circuit.description, name: @circuit.name } }
